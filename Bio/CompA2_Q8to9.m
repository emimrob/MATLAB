...
%import data
data2 = load('data_2.mat');
data2 = data2.data;

times = 1000*data2(:,1);%convert to ms for clarity
...
title('Solution curves for conversion of MeCHO into acetyl-CoA with aldehyde dehydrogenase');
